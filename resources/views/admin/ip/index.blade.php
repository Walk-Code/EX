...
@section("content")
    ...
    <div class="box-body bg-white" >
                ...
                <div class="row" style="display: flex;">
                    <form class="cp-left" action="{{url('/admin/topic')}}" method="post" style="padding: 0px 0px 10px 31px;width: 50%">
                        ...
                        <div class="dataTables_length" id="example1_length">
                            <input type="search" class="form-control"  aria-controls="search" name="key"  placeholder="搜索用ip" @if(!empty($key)) value="{{$key}}" @endif>
        ...
        <div class="">
            ...
            <table class="table table-bordered table-striped datatable" role="grid" aria-describedby="example1_info" style="text-align: center;margin-top: 10px;">
                <thead>
                <tr role="row" >
